...
const AboutPanel = ({counter}) => {
	return(
		<AboutPanelDiv>
			...
			<p>You can find me on <a href="https://twitter.com/_madison______" target="_blank" rel="noopener">twitter</a>, <a href="https://soundcloud.com/madisonbullard" target="_blank" rel="noopener">soundcloud</a>, and also <a href="http://linkedin.com/in/madisonbullard" target="_blank" rel="noopener">linkedin</a> if you’re into that.</p>
			<p>You can watch my reel <a href="reel" target="_blank" rel="noopener">here</a></p>
		</AboutPanelDiv>
	)
}
